...
# %%
resultados = dict()
for neuronios in [2**x for x in range(5,9)]:
    print(f'{"#"*20} {ordem} Amostras {"#"*20}')
    ...
    model = Sequential()
    model.add(Dense(neuronios, activation='relu', input_shape=(ordem,)))
...
#%%
# nome_arquivo = 'Result_dif_num_neuronios.pkl'
